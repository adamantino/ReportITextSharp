...
{
    class CellShadowDown : IPdfPCellEvent
    {

        //Holds pointer to main PdfWriter object
        private PdfWriter w;

        public CellShadowDown(PdfWriter w)
        {
            this.w = w;
        }
        ...
        public void CellLayout(PdfPCell cell, Rectangle position, PdfContentByte[] canvases)
        {
            ...
            PdfShading shading = PdfShading.SimpleAxial(w, position.Left, position.Bottom, position.Left, position.Top, BaseColor.WHITE, new BaseColor(225, 225, 225));
