...
{
    class CellShadowTopRightCorner : IPdfPCellEvent
    {
        //Holds pointer to main PdfWriter object
        private PdfWriter w;

        public CellShadowTopRightCorner(PdfWriter w)
        {
            this.w = w;
        }
        ...
        public void CellLayout(PdfPCell cell, Rectangle position, PdfContentByte[] canvases)
        {
            ...
            PdfShading shading = PdfShading.SimpleAxial(w, position.Left, position.Bottom, position.Right - position.Width/2, position.Top - position.Height/2, new BaseColor(225, 225, 225), BaseColor.WHITE);
